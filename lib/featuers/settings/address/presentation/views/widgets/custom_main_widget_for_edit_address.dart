...
class CustomMainWidgetForEditAddress extends StatefulWidget {
  const CustomMainWidgetForEditAddress({super.key});

  @override
  State<CustomMainWidgetForEditAddress> createState() =>
      _CustomMainWidgetForEditAddressState();
}

class _CustomMainWidgetForEditAddressState
    extends State<CustomMainWidgetForEditAddress> {
  int selectedIndex = 0;
  @override
